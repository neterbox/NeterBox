...
//        MyUtility.showToast(context,context.getResources().getString(R.string.connection_error));
...
//            MyUtility.showToast(context,context.getResources().getString(R.string.reconnect_alert)+seconds);
