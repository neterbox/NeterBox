...
public class share_location_customview extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_share_location_customview);
        init();
        setListeners();
    }
    // Initialize views
    ...
    private void setListeners() {
        ...
        shareImage.setOnClickListener((View.OnClickListener) this);
        shareText.setOnClickListener((View.OnClickListener) this);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.btnTextShare:
                ...
                if (!getText.equals("") && getText.length() != 0)
                    ...
                    Toast.makeText(share_location_customview.this,
            ...
            case select_photo:
                if (resultcode == RESULT_OK) {
                    try {
                        ...
                        // data
                        Bitmap bitmap = Helper.decodeUri(share_location_customview.this,
                                imageUri, 200);// call
                        // deocde
                        // uri
                        // method
                        ...
                        e.printStackTrace();
                        Toast.makeText(share_location_customview.this, "File not found.",
                                Toast.LENGTH_SHORT).show();
                    }
                }
        }
