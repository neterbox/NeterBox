...
//
//import com.protalk.R;
//import com.protalk.qb.ChatHelper;
//import com.protalk.utils.Constants;
...
////    }
////
////    public AttachmentPreviewAdapter(Context context, List<File> objectsList) {
...
//                    Log.e("attachment size", ":" + fileQBAttachmentMap.values().size());
//
...
//                    fileUploadProgressMap.remove(item);
//                    fileQBAttachmentMap.put(item, result);
//                    Log.e("attachment size", ":" + fileQBAttachmentMap.values());
//
//                    notifyDataSetChanged();
//                }
//
